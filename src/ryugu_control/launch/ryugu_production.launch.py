"""
ryugu_production.launch.py — Full Production Stack for RYUGU ROV

Launches all nodes required for competition operation:
  1. MAVROS node (Pixhawk ↔ ROS2 bridge via USB serial)
...
Usage:
  ...
  ros2 launch ryugu_control ryugu_production.launch.py fcu_url:=/dev/ttyUSB0:115200
  ...
  ros2 launch ryugu_control ryugu_production.launch.py enable_webcam:=false
"""
...
def generate_launch_description():
    ...
    fcu_url_arg = DeclareLaunchArgument(
        ...
        description='FCU connection URL.  /dev/ttyACM0:115200 for USB serial.',
    )
    ...
    banner = LogInfo(msg=[
        '\n',
        '╔══════════════════════════════════════════════════════════════════╗\n',
        '║              RYUGU ROV — Production Stack                        ║\n',
        '║                                                                  ║\n',
        '║  FCU:  ', LaunchConfiguration('fcu_url'), '\n',
